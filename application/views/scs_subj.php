...
<head>
	...
	<meta name="description" content="TS System">
	<meta name="author" content="Digital-south.com">
...
<body dir="rtl">
	...
	<div class="container">
				<div class="row">
					<div class="col-md-8">
						<h3 class="section-title">تمت العملية بنجاح  ... شكرا</h3>
						<p>
                                                <h4><a href="<?php echo base_url()."home/logout" ?>">تسجيل خروج </a></h4> او  <h4><a href="<?php echo base_url()."index.php/subj" ?>">العودة الي ادخال المواد</a></h4>
						</p>
